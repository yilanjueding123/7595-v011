	   ...
	   if	(WIDTH == 1280 && HEIGHT == 720)
		{
		   if((ap_state_config_video_resolution_get()==2)\
			   || (ap_state_config_video_resolution_get()==4))
		   {
		   	
			  for (i=0; i<sizeof(GC1004_MIPI_25FPS_720P)/2; i++) 
			  {
				  reg_tmp = GC1004_MIPI_25FPS_720P[i][0];
				  data_tmp =  GC1004_MIPI_25FPS_720P[i][1];
				  sccb_write(GC1004_SLAVE_ID,GC1004_MIPI_25FPS_720P[i][0], GC1004_MIPI_25FPS_720P[i][1]);
		   ...
		   else if(ap_state_config_video_resolution_get()==0)		//1080p
		   {
